...
\citet{brinkman2024}. I have implemented this procedure in
\texttt{src/R/10\_recover\_fundamentals.R} and saved amenity and
productivity data in \texttt{output/tables/amenity.csv} and
\texttt{output/tables/productivity.csv}.
